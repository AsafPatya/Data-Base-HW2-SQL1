...
class Test(AbstractTest):
    ...
    def test_File(self) -> None:
        ...
        self.assertEqual(file.getFileID(), 1, "Should work167")
        self.assertEqual(file.getType(), "MP3", "Should work168")
        self.assertEqual(file.getSize(), 10, "Should work169")
        # check delete
        self.assertEqual(Status.OK, Solution.deleteFile(File(4, "MP3", 0)), "Should work170")
        self.assertEqual(Status.OK, Solution.deleteFile(File(4, "MP3", 0)), "Should work171")
    ...
    def test_addDiskAndFile(self) -> None:
        ...
        self.assertEqual(Status.ERROR, Solution.addDiskAndFile(Disk(1, "DELL", 10, 10, 10),
                                                               File(1, "MP3", 0)),
                         "ERROR in case of a database error1")
        self.assertEqual(Status.ERROR, Solution.deleteDisk(1), "ERROR in case of a database error2")
        self.assertEqual(Status.ERROR, Solution.deleteFile(File(1, "MP3", 0)), "ERROR in case of a database error3")
        Solution.createTables()
        # basic test
